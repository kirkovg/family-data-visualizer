let FamilyDataVisualizer = {
    ...
    updateFamilyData: function () {
        ...
        $.ajax({
            ...
            success() {
                FamilyDataVisualizer.getFamilyData(); // get the updated data back and rebuild the tree
            }
        });
    }
};
