...
function getFamilyDataOnStartup() {
    $.ajax({
        url: "https://599f0ce8d3276800116b9d4e.mockapi.io/api/family-data/people",
        dataType: "json",
        success: function (data) {
            data.forEach(function (item) { familyData.push(item) });
            init();
        }
    });
}
...
function updateFamilyData() {
    // TODO: create a put request to the mock api
}
